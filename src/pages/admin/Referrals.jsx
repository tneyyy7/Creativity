...
function CreateCodeModal({ existing, onClose, onCreated, t }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#15141d] border border-white/10 rounded-3xl shadow-2xl animate-in fade-in zoom-in-95 duration-200 p-6 space-y-5">
        <button
          onClick={onClose}
